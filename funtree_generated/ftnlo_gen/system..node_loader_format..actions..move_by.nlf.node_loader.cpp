...
#include "./system..node_loader_format..actions..move_by.nlf.node_loader.h"
...
static void ___NodeLoaderBundleRegisterer___ () {
  ...
  NodeLoaderBundle::default_bundle().registerLoader(
      vector<string>{"Action.MoveBy", "MoveBy", },
      vector<string>{"ActionGroup", },
      make_shared<NodeLoader_SystemNodeloaderformatActionsMovebyNlf>(),
      true
  );
}
...
string const& NodeLoader_SystemNodeloaderformatActionsMovebyNlf::loadable_class () const {
  static string cls = "ActionLoadable";
  return cls;
}


bool NodeLoader_SystemNodeloaderformatActionsMovebyNlf::isCompatibleLoadable (shared_ptr<NodeLoadable> const& loadable) {
  return dpc<ActionLoadable>(loadable) != null;
}


bool NodeLoader_SystemNodeloaderformatActionsMovebyNlf::_preLoad (
    LoaderContext& ctx,
...
bool NodeLoader_SystemNodeloaderformatActionsMovebyNlf::_postLoad (
    LoaderContext& ctx,
    shared_ptr<Node> const& node,
    shared_ptr<NodeLoadable> const& loadable
) {
  ...
  static uint code_path_id = PathRegistry::lookUp("system/node_loader_format/actions/move_by.nlf");
  auto code_set = CodeSetBundle::default_bundle().getCodeSet(code_path_id);
  unlikely (code_set == null) {
    LOG_ERR("code_set is null --- system/node_loader_format/actions/move_by.nlf");
    return null;
  }
...
shared_ptr<Format> const&  NodeLoader_SystemNodeloaderformatActionsMovebyNlf::_getFormat () {
