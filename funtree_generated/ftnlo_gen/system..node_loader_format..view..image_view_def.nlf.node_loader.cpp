...
#include "./system..node_loader_format..view..image_view_def.nlf.node_loader.h"
...
#include "./system..node_loader_format..view..image_view_def.nlf.node_loader.0.code"
...
static void ___NodeLoaderBundleRegisterer___ () {
  ...
  NodeLoaderBundle::default_bundle().registerLoader(
      vector<string>{"ImageViewDef", "ImageView", "Image", },
      vector<string>{"ViewDefGroup", "ObjectTraitGroup", },
      make_shared<NodeLoader_SystemNodeloaderformatViewImageviewdefNlf>(),
      true
  );
}
...
string const& NodeLoader_SystemNodeloaderformatViewImageviewdefNlf::loadable_class () const {
  static string cls = "ImageViewDef";
  return cls;
}


bool NodeLoader_SystemNodeloaderformatViewImageviewdefNlf::isCompatibleLoadable (shared_ptr<NodeLoadable> const& loadable) {
  return dpc<ImageViewDef>(loadable) != null;
}


bool NodeLoader_SystemNodeloaderformatViewImageviewdefNlf::_preLoad (
    LoaderContext& ctx,
...
bool NodeLoader_SystemNodeloaderformatViewImageviewdefNlf::_postLoad (
    LoaderContext& ctx,
    shared_ptr<Node> const& node,
    shared_ptr<NodeLoadable> const& loadable
) {
...
shared_ptr<Format> const&  NodeLoader_SystemNodeloaderformatViewImageviewdefNlf::_getFormat () {
