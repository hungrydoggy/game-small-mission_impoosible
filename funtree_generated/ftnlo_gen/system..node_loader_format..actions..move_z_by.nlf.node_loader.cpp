...
#include "./system..node_loader_format..actions..move_z_by.nlf.node_loader.h"
...
static void ___NodeLoaderBundleRegisterer___ () {
  ...
  NodeLoaderBundle::default_bundle().registerLoader(
      vector<string>{"Action.MoveZBy", "MoveZBy", },
      vector<string>{"ActionGroup", },
      make_shared<NodeLoader_SystemNodeloaderformatActionsMovezbyNlf>(),
      true
  );
}
...
string const& NodeLoader_SystemNodeloaderformatActionsMovezbyNlf::loadable_class () const {
  static string cls = "ActionLoadable";
  return cls;
}


bool NodeLoader_SystemNodeloaderformatActionsMovezbyNlf::isCompatibleLoadable (shared_ptr<NodeLoadable> const& loadable) {
  return dpc<ActionLoadable>(loadable) != null;
}


bool NodeLoader_SystemNodeloaderformatActionsMovezbyNlf::_preLoad (
    LoaderContext& ctx,
...
bool NodeLoader_SystemNodeloaderformatActionsMovezbyNlf::_postLoad (
    LoaderContext& ctx,
    shared_ptr<Node> const& node,
    shared_ptr<NodeLoadable> const& loadable
) {
  ...
  static uint code_path_id = PathRegistry::lookUp("system/node_loader_format/actions/move_z_by.nlf");
  auto code_set = CodeSetBundle::default_bundle().getCodeSet(code_path_id);
  unlikely (code_set == null) {
    LOG_ERR("code_set is null --- system/node_loader_format/actions/move_z_by.nlf");
    return null;
  }
...
shared_ptr<Format> const&  NodeLoader_SystemNodeloaderformatActionsMovezbyNlf::_getFormat () {
