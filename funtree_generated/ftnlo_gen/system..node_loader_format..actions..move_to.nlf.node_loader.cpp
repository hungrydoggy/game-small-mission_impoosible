...
#include "./system..node_loader_format..actions..move_to.nlf.node_loader.h"
...
static void ___NodeLoaderBundleRegisterer___ () {
  ...
  NodeLoaderBundle::default_bundle().registerLoader(
      vector<string>{"Action.MoveTo", "MoveTo", },
      vector<string>{"ActionGroup", },
      make_shared<NodeLoader_SystemNodeloaderformatActionsMovetoNlf>(),
      true
  );
}
...
string const& NodeLoader_SystemNodeloaderformatActionsMovetoNlf::loadable_class () const {
  static string cls = "ActionLoadable";
  return cls;
}


bool NodeLoader_SystemNodeloaderformatActionsMovetoNlf::isCompatibleLoadable (shared_ptr<NodeLoadable> const& loadable) {
  return dpc<ActionLoadable>(loadable) != null;
}


bool NodeLoader_SystemNodeloaderformatActionsMovetoNlf::_preLoad (
    LoaderContext& ctx,
...
bool NodeLoader_SystemNodeloaderformatActionsMovetoNlf::_postLoad (
    LoaderContext& ctx,
    shared_ptr<Node> const& node,
    shared_ptr<NodeLoadable> const& loadable
) {
...
shared_ptr<Format> const&  NodeLoader_SystemNodeloaderformatActionsMovetoNlf::_getFormat () {
