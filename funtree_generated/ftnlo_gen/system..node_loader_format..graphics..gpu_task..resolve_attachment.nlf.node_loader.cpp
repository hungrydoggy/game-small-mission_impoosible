...
#include "./system..node_loader_format..graphics..gpu_task..resolve_attachment.nlf.node_loader.h"
...
static void ___NodeLoaderBundleRegisterer___ () {
  ...
  NodeLoaderBundle::default_bundle().registerLoader(
      vector<string>{"ResolveAttachment", },
      vector<string>{"AttachmentGroup", },
      make_shared<NodeLoader_SystemNodeloaderformatGraphicsGputaskResolveattachmentNlf>(),
      true
  );
}
...
string const& NodeLoader_SystemNodeloaderformatGraphicsGputaskResolveattachmentNlf::loadable_class () const {
  static string cls = "AttachmentInfo";
  return cls;
}


bool NodeLoader_SystemNodeloaderformatGraphicsGputaskResolveattachmentNlf::isCompatibleLoadable (shared_ptr<NodeLoadable> const& loadable) {
  return dpc<AttachmentInfo>(loadable) != null;
}


bool NodeLoader_SystemNodeloaderformatGraphicsGputaskResolveattachmentNlf::_preLoad (
    LoaderContext& ctx,
  ...
  static uint code_path_id = PathRegistry::lookUp("system/node_loader_format/graphics/gpu_task/resolve_attachment.nlf");
  auto code_set = CodeSetBundle::default_bundle().getCodeSet(code_path_id);
  unlikely (code_set == null) {
    LOG_ERR("code_set is null --- system/node_loader_format/graphics/gpu_task/resolve_attachment.nlf");
    return null;
  }
...
bool NodeLoader_SystemNodeloaderformatGraphicsGputaskResolveattachmentNlf::_postLoad (
    LoaderContext& ctx,
    shared_ptr<Node> const& node,
    shared_ptr<NodeLoadable> const& loadable
) {
...
shared_ptr<Format> const&  NodeLoader_SystemNodeloaderformatGraphicsGputaskResolveattachmentNlf::_getFormat () {
