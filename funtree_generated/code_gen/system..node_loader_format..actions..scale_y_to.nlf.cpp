...
#include "./system..node_loader_format..actions..scale_y_to.nlf.h"
...
static Var __code_0 (
  ...
  #include "system..node_loader_format..actions..scale_y_to.nlf.0.code"
}
...
Var Code_SystemNodeloaderformatActionsScaleytoNlf::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..node_loader_format..actions..scale_y_to.nlf.cpp\"", code_idx);
      return null_var;
  }
}
