...
#include "./system..node_loader_format..actions..move_y_to.nlf.h"
...
static Var __code_0 (
  ...
  #include "system..node_loader_format..actions..move_y_to.nlf.0.code"
}
...
Var Code_SystemNodeloaderformatActionsMoveytoNlf::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..node_loader_format..actions..move_y_to.nlf.cpp\"", code_idx);
      return null_var;
  }
}
