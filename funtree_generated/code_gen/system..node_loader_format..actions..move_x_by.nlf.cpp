...
#include "./system..node_loader_format..actions..move_x_by.nlf.h"
...
static Var __code_0 (
  ...
  #include "system..node_loader_format..actions..move_x_by.nlf.0.code"
}
...
Var Code_SystemNodeloaderformatActionsMovexbyNlf::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..node_loader_format..actions..move_x_by.nlf.cpp\"", code_idx);
      return null_var;
  }
}
