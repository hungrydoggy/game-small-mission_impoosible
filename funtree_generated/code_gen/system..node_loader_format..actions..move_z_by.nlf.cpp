...
#include "./system..node_loader_format..actions..move_z_by.nlf.h"
...
static Var __code_0 (
  ...
  #include "system..node_loader_format..actions..move_z_by.nlf.0.code"
}
...
Var Code_SystemNodeloaderformatActionsMovezbyNlf::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..node_loader_format..actions..move_z_by.nlf.cpp\"", code_idx);
      return null_var;
  }
}
