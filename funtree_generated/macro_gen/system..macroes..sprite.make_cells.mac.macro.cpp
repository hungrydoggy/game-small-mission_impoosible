...
#include "./system..macroes..sprite.make_cells.mac.macro.h"
...
#include "./system..macroes..sprite.make_cells.mac.macro.0.code"



#include "./system..macroes..sprite.make_cells.mac.macro.1.code"
...
shared_ptr<Content> Macro_SystemMacroesSpriteMakecellsMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..sprite.make_cells.mac.macro.cpp\"", code_idx);
      return null;
  }
}
...
#include "./system..macroes..sprite.make_cells.mac.macro.15.code"
