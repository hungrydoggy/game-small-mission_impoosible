...
#include "./system..macroes..physics_shape.make_half_size_from_image_size.mac.macro.h"
...
#include "./system..macroes..physics_shape.make_half_size_from_image_size.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesPhysicsshapeMakehalfsizefromimagesizeMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..physics_shape.make_half_size_from_image_size.mac.macro.cpp\"", code_idx);
      return null;
  }
}
