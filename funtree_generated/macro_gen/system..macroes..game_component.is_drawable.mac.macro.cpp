...
#include "./system..macroes..game_component.is_drawable.mac.macro.h"
...
#include "./system..macroes..game_component.is_drawable.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesGamecomponentIsdrawableMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..game_component.is_drawable.mac.macro.cpp\"", code_idx);
      return null;
  }
}
