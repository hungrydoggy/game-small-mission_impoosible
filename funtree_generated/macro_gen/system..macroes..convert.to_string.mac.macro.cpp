...
#include "./system..macroes..convert.to_string.mac.macro.h"
...
#include "./system..macroes..convert.to_string.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesConvertTostringMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..convert.to_string.mac.macro.cpp\"", code_idx);
      return null;
  }
}
