...
#include "./system..macroes..math.floor.mac.macro.h"
...
#include "./system..macroes..math.floor.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesMathFloorMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..math.floor.mac.macro.cpp\"", code_idx);
      return null;
  }
}
