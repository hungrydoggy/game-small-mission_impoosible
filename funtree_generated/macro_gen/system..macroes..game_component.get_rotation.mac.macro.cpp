...
#include "./system..macroes..game_component.get_rotation.mac.macro.h"
...
#include "./system..macroes..game_component.get_rotation.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesGamecomponentGetrotationMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..game_component.get_rotation.mac.macro.cpp\"", code_idx);
      return null;
  }
}
