...
#include "./system..macroes..math.log.mac.macro.h"
...
#include "./system..macroes..math.log.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesMathLogMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..math.log.mac.macro.cpp\"", code_idx);
      return null;
  }
}
