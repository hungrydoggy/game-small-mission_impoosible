...
#include "./system..macroes..game_component.get_children_names.mac.macro.h"
...
#include "./system..macroes..game_component.get_children_names.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesGamecomponentGetchildrennamesMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..game_component.get_children_names.mac.macro.cpp\"", code_idx);
      return null;
  }
}
