...
#include "./system..macroes..convert.to_real.mac.macro.h"
...
#include "./system..macroes..convert.to_real.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesConvertTorealMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..convert.to_real.mac.macro.cpp\"", code_idx);
      return null;
  }
}
