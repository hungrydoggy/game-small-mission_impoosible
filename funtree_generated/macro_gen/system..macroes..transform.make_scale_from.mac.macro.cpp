...
#include "./system..macroes..transform.make_scale_from.mac.macro.h"
...
#include "./system..macroes..transform.make_scale_from.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesTransformMakescalefromMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..transform.make_scale_from.mac.macro.cpp\"", code_idx);
      return null;
  }
}
