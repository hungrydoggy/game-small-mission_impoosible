...
#include "./system..macroes..sequence.pick.mac.macro.h"
...
#include "./system..macroes..sequence.pick.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesSequencePickMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..sequence.pick.mac.macro.cpp\"", code_idx);
      return null;
  }
}
