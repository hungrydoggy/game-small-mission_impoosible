...
#include "./system..macroes..math.acos.mac.macro.h"
...
#include "./system..macroes..math.acos.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesMathAcosMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..math.acos.mac.macro.cpp\"", code_idx);
      return null;
  }
}
