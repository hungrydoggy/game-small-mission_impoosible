...
#include "./system..macroes..random.draw_real.mac.macro.h"
...
#include "./system..macroes..random.draw_real.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesRandomDrawrealMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..random.draw_real.mac.macro.cpp\"", code_idx);
      return null;
  }
}
