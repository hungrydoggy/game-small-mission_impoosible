...
#include "./system..macroes..view.get_image_size.mac.macro.h"
...
#include "./system..macroes..view.get_image_size.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesViewGetimagesizeMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..view.get_image_size.mac.macro.cpp\"", code_idx);
      return null;
  }
}
