...
#include "./system..macroes..global.has_data.mac.macro.h"
...
#include "./system..macroes..global.has_data.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesGlobalHasdataMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..global.has_data.mac.macro.cpp\"", code_idx);
      return null;
  }
}
