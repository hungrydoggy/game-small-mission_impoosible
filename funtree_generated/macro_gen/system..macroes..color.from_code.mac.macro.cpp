...
#include "./system..macroes..color.from_code.mac.macro.h"
...
#include "./system..macroes..color.from_code.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesColorFromcodeMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..color.from_code.mac.macro.cpp\"", code_idx);
      return null;
  }
}
