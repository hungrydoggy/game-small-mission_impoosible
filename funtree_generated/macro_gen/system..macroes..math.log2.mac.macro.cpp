...
#include "./system..macroes..math.log2.mac.macro.h"
...
#include "./system..macroes..math.log2.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesMathLog2Mac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..math.log2.mac.macro.cpp\"", code_idx);
      return null;
  }
}
