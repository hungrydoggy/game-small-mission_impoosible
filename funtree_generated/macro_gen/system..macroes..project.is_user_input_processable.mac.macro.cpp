...
#include "./system..macroes..project.is_user_input_processable.mac.macro.h"
...
#include "./system..macroes..project.is_user_input_processable.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesProjectIsuserinputprocessableMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..project.is_user_input_processable.mac.macro.cpp\"", code_idx);
      return null;
  }
}
