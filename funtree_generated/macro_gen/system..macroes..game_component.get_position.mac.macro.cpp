...
#include "./system..macroes..game_component.get_position.mac.macro.h"
...
#include "./system..macroes..game_component.get_position.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesGamecomponentGetpositionMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..game_component.get_position.mac.macro.cpp\"", code_idx);
      return null;
  }
}
