...
#include "./system..macroes..sequence.make_int_sequence.mac.macro.h"
...
shared_ptr<Content> Macro_SystemMacroesSequenceMakeintsequenceMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..sequence.make_int_sequence.mac.macro.cpp\"", code_idx);
      return null;
  }
}
