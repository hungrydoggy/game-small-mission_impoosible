...
#include "./system..macroes..math.tan.mac.macro.h"
...
#include "./system..macroes..math.tan.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesMathTanMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..math.tan.mac.macro.cpp\"", code_idx);
      return null;
  }
}
