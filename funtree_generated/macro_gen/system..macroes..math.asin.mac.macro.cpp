...
#include "./system..macroes..math.asin.mac.macro.h"
...
#include "./system..macroes..math.asin.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesMathAsinMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..math.asin.mac.macro.cpp\"", code_idx);
      return null;
  }
}
