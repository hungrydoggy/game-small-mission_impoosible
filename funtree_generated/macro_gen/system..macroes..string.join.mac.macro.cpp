...
#include "./system..macroes..string.join.mac.macro.h"
...
#include "./system..macroes..string.join.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesStringJoinMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..string.join.mac.macro.cpp\"", code_idx);
      return null;
  }
}
