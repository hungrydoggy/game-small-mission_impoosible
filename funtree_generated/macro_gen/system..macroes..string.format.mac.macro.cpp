...
#include "./system..macroes..string.format.mac.macro.h"
...
#include "./system..macroes..string.format.mac.macro.0.code"
...
shared_ptr<Content> Macro_SystemMacroesStringFormatMac::execute (
  ...
  switch (code_idx) {
    ...
    default:
      LOG_ERR("unknown code_idx %u --- \"system..macroes..string.format.mac.macro.cpp\"", code_idx);
      return null;
  }
}
